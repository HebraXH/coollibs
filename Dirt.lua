...
function TempTween(Object, TI, Properties)
    local NewTween = TweenService:Create(Object, TI, Properties)
...
function Lib:CreateWindow(Name)
    ...
    function Window:Toggle(name, options, callback)
        ...
        local toggle_round = Instance.new("UICorner")
        ...
        toggle.Size = UDim2.new(0.725, 0, 0.725, 0)
        toggle.Position = UDim2.new(0, 0, 0.135, 0)
        toggle.TextTransparency = 1

        toggle_round.CornerRadius = UDim.new(0.25, 0)
        toggle_round.Parent = toggle
    ...
    function Window:ColorPicker(name, options, callback)
        ...
        ColorPickerHolder.Parent = Toggle
        ColorPickerHolder.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
        ColorPickerHolder.Position = UDim2.new(1.05, 0, 1, 0)
        ColorPickerHolder.Size = UDim2.new(1, 0, 1, 0)
        ColorPickerHolder.Visible = false

        UICorner.Parent = ColorPickerHolder

        RTextBox.Name = "RTextBox"
        RTextBox.Parent = ColorPickerHolder
        RTextBox.BackgroundColor3 = Color3.fromRGB(75, 75, 75)
        RTextBox.BorderSizePixel = 0
        RTextBox.Position = UDim2.new(0.0550458729, 0, 0.216810971, 0)
        RTextBox.Size = UDim2.new(0.266055048, 0, 0.555555582, 0)
        RTextBox.ClearTextOnFocus = false
        RTextBox.Font = Enum.Font.GothamBold
        RTextBox.PlaceholderText = "R"
        RTextBox.Text = math.floor(default.R * 255)
        ...
        GTextBox.Parent = ColorPickerHolder
        GTextBox.BackgroundColor3 = Color3.fromRGB(75, 75, 75)
        GTextBox.BorderSizePixel = 0
        GTextBox.Position = UDim2.new(0.366972476, 0, 0.216810971, 0)
        GTextBox.Size = UDim2.new(0.266055048, 0, 0.555555582, 0)
        GTextBox.ClearTextOnFocus = false
        GTextBox.Font = Enum.Font.GothamBold
        GTextBox.PlaceholderText = "G"
        GTextBox.Text = math.floor(default.G * 255)
        ...
        BTextBox.Parent = ColorPickerHolder
        BTextBox.BackgroundColor3 = Color3.fromRGB(75, 75, 75)
        BTextBox.BorderSizePixel = 0
        BTextBox.Position = UDim2.new(0.683486223, 0, 0.216810971, 0)
        BTextBox.Size = UDim2.new(0.266055048, 0, 0.555555582, 0)
        BTextBox.ClearTextOnFocus = false
        BTextBox.Font = Enum.Font.GothamBold
        BTextBox.PlaceholderText = "B"
        BTextBox.Text = math.floor(default.B * 255)
        ...
        local function DoStuff()
            if not tonumber(RTextBox.Text) then
                RTextBox.Text = 255
            end
            if not tonumber(GTextBox.Text) then
                GTextBox.Text = 255
            end
            if not tonumber(BTextBox.Text) then
                BTextBox.Text = 255
            end
        ...
        Text_2.MouseButton1Click:Connect(function()
            isOn = not isOn
            ColorPickerHolder.Visible = isOn
        end)
        Update(25)
    end
